<template>
  <div>
    ...
    <b-card class="blog-edit-wrapper">
      <b-row class="mx-1">
        <b-col md="4">
          <h1>Bonus (next deposit)</h1>
          <p>Format 900px x 180px JPG (.jpg / .jpeg / .png) 500KB</p>
        </b-col>

        <!-- ENABLE DISBLE THIS -->
        <b-col cols="8" class="text-right mt-2">
          <b-form-group v-model="getPromoNextDepo.enabled">
            <b-form-checkbox
              name="check-button"
              switch
              inline
              v-model="getPromoNextDepo.enabled"
            >
            </b-form-checkbox>
          </b-form-group>
        </b-col>
      ...
      <!-- <b-col md="12" class="py-4 ml-1">
        <h3>Photo preview :</h3>
        <b-img src="./image/12.jpeg" alt="Responsive image"></b-img>
      </b-col> -->
      <b-col md="12" class="py-4 ml-1">
        <h3>Photo preview :</h3>
        <b-img
        ...
        ></b-img>
        <b-img
          :src="image + getPromoNextDepo.image"
          v-else
      ...
      <v-row class="d-flex mx-1">
        ...
        <b-col md="3">
          ...
          >
            <b-form-input
              v-model="getPromoNextDepo.alt"
              id="blog-edit-title"
              placeholder="ALT IMG"
            />
            <b-form-input
              hidden
              v-model="getPromoNextDepo.image"
              id="blog-edit-title"
        ...
        <b-col md="3">
          ...
          >
            <b-form-input
              v-model="getPromoNextDepo.title"
              id="blog-edit-title"
        ...
        <!-- Max Bonus Diberikan (Rp) -->
        <b-col md="3">
          <b-form-group
            label="Max Bonus Diberikan (Rp)"
            label-for="blog-edit-title"
            class="mb-2"
          >
            <b-form-input
              v-model="getPromoNextDepo.max_bonus_given"
              id="blog-edit-title"
              placeholder="Max Bonus Diberikan"
            />
          </b-form-group>
        </b-col>
        ...
        <b-col md="3">
          ...
          >
            <b-form-input
              v-model="getPromoNextDepo.value_bonus"
              id="blog-edit-title"
              placeholder="Value"
            />
          </b-form-group>
        ...
        <b-row>
          <b-col cols="12">
            ...
            >
              <quill-editor
                id="blog-content"
                v-model="getPromoNextDepo.content"
              />
            </b-form-group>
          </b-col>
          ...
          <b-col cols="12" class="mt-50">
            <b-button
              ...
              class="mr-1"
              @click="
                updateData(getPromoNextDepo, fileImage, 'success', 'top-center')
              "
            >
              Save
            </b-button>
...
export default {
  ...
  data() {
    return {
      imagesName:
        'photos/cms/promotion/0pYvB1Nc4FARGsqvk7JQNvAj1WZJ9SvHDvZiKTtB.jpeg',
      types: 'bonus_next_deposit',
      fileImage: null,
      previeImg: null,
      file: null,
  ...
  computed: {
    ...
    ...mapGetters('cms', ['getPromoNextDepo']),
  },
  created() {
    const payload = {
      type: this.types,
    }
    this.promoNexDepositlist(payload)
  },

  methods: {
    ...mapActions('cms', ['promoNexDepositlist', 'updatenextDeposit']),
    previewImage(e) {
