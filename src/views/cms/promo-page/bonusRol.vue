<template>
  <div>
    ...
    <b-card class="blog-edit-wrapper">
      <b-row class="mx-1">
        <b-col md="4">
          <h1>Bonus Rollingan Live Casino</h1>
          <p>Format 900px x 180px JPG (.jpg / .jpeg / .png) < 500KB</p>
        </b-col>
        <b-col cols="8" class="text-right mt-2">
          <b-form-group v-model="getPromoRolingan.enabled">
            <b-form-checkbox
              name="check-button"
              switch
              inline
              v-model="getPromoRolingan.enabled"
            >
            </b-form-checkbox>
          </b-form-group>
        </b-col>
      ...
      <b-col md="12" class="py-4 ml-1">
        ...
        ></b-img>
        <b-img
          :src="image + getPromoRolingan.image"
          v-else
      ...
      <v-row class="d-flex mx-1">
        <b-col md="6">
          ...
          >
            <b-form-input
              v-model="getPromoRolingan.alt"
              id="blog-edit-title"
              placeholder="ALT IMG"
            />
            <b-form-input
              hidden
              v-model="getPromoRolingan.image"
              id="blog-edit-title"
        ...
        <b-col md="6">
          ...
          >
            <b-form-input
              v-model="getPromoRolingan.title"
              id="blog-edit-title"
              placeholder="Tittle"
            />
          </b-form-group>
        ...
        <b-row>
          <b-col cols="12">
            ...
            >
              <quill-editor
                id="blog-content"
                v-model="getPromoRolingan.content"
              />
            </b-form-group>
          </b-col>
          ...
          <b-col cols="12" class="mt-50">
            <b-button
              ...
              class="mr-1"
              @click="
                updateData(getPromoRolingan, fileImage, 'success', 'top-center')
              "
            >
              Save
            </b-button>
...
export default {
  ...
  computed: {
    ...
    ...mapGetters('cms', ['getPromoRolingan']),
  },
  ...
  created() {
    ...
    this.promoRolinganlist(payload)
  },

  methods: {
    ...mapActions('cms', ['promoRolinganlist']),
      ...
      this.$swal({
        ...
        if (result.value) {
          ...
          useJwt
            .createData(
              'cms',
              `/promo-page-bonus-rolling-live-casino-update/${id}`,
              getFormData(body),
              {
                headers: {
