    ...
    <b-card class="blog-edit-wrapper">
      <b-row class="mx-1">
        ...
        <b-col cols="8" class="text-right mt-2">
          <b-form-group v-model="getPromoCashback.enabled">
            <b-form-checkbox
              name="check-button"
              switch
              inline
              v-model="getPromoCashback.enabled"
            >
            </b-form-checkbox>
          </b-form-group>
        </b-col>
      ...
      <b-col md="12" class="py-4 ml-1">
        ...
        ></b-img>
        <b-img
          :src="image + getPromoCashback.image"
          v-else
      ...
      <v-row class="d-flex mx-1">
        ...
        <b-col md="6">
          ...
          >
            <b-form-input
              v-model="getPromoCashback.title"
              id="blog-edit-title"
              placeholder="Tittle"
            />
          </b-form-group>
        ...
        <b-row>
          <b-col cols="12">
            ...
            >
              <quill-editor
                id="blog-content"
                v-model="getPromoCashback.content"
              />
            </b-form-group>
          </b-col>
          ...
          <b-col cols="12" class="mt-50">
            <b-button
              ...
              class="mr-1"
              @click="
                updateData(getPromoCashback, fileImage, 'success', 'top-center')
              "
            >
              Save
            </b-button>
...
export default {
  ...
  computed: {
    ...mapGetters('cms', ['getPromoCashback']),
  },
  created() {
    const payload = {
      type: this.types,
    }
    this.promoCashbacklist(payload)
  },

  methods: {
    ...mapActions('cms', ['promoCashbacklist']),
