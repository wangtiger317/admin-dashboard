      ...
      <b-row>
        ...
        <b-col cols="12">
          ...
          >
            <quill-editor
              id="blog-content"
              v-model="getFiftySpecial.contents"
            />
          </b-form-group>
        </b-col>
        ...
        <b-col cols="12" class="mt-50">
          <b-button
            ...
            variant="primary"
            class="mr-1"
            @click="updatesData('success', 'top-center', getFiftySpecial)"
          >
            Save
          </b-button>
        </b-col>
...
export default {
  ...
  computed: {
    ...mapGetters('cms', ['getFiftySpecial']),
  },
  ...
  created() {
    ...
    this.gameFiftySpeciallist(payload)
  },
  ...
  methods: {
    ...mapActions('cms', ['gameFiftySpeciallist', 'updateAll']),
