      ...
      <b-row>
        ...
        <b-col cols="12">
          <b-form-group
            ...
            class="mb-2"
          >
            <quill-editor id="blog-content" v-model="getColokJitu.contents" />
          </b-form-group>
        </b-col>
        ...
        <b-col cols="12" class="mt-50">
          <b-button
            ...
            variant="primary"
            class="mr-1"
            @click="updatesData('success', 'top-center', getColokJitu)"
          >
            Save
          </b-button>
        </b-col>
...
export default {
  ...
  created() {
    ...
    this.gameColokJitulist(payload)
  },
  ...
  methods: {
    ...mapActions('cms', ['gameColokJitulist', 'updateAll']),
