      ...
      <b-row>
        ...
        <b-col cols="12">
          <b-form-group
            ...
            class="mb-2"
          >
            <quill-editor id="blog-content" v-model="getGameNormal.contents" />
          </b-form-group>
        </b-col>
        ...
        <b-col cols="12" class="mt-50">
          <b-button
            ...
            variant="primary"
            class="mr-1"
            @click="updatesData('success', 'top-center', getGameNormal)"
          >
            Save
          </b-button>
        </b-col>
...
export default {
  ...
  methods: {
    ...mapActions('cms', ['gameNormallist', 'updateAll']),
