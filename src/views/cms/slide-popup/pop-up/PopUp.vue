      ...
      <div class="mx-4 my-2">
        ...
        <b-form ref="form">
          <b-row>
            ...
            <!-- Item CHECk -->
            <b-col md="2 mt-1">
              <b-form-group v-model="getSlidePopUp[0].enabled">
                <b-form-checkbox
                  name="check-button"
                  class="mt-2"
                  switch
                  inline
                  v-model="getSlidePopUp[0].enabled"
                >
                </b-form-checkbox>
              </b-form-group>
            </b-col>
            ...
            <b-col md="2" class="py-2">
              ...
              ></b-img>
              <b-img
                :src="image + getSlidePopUp[0].image"
                v-else
...
export default {
  ...
  created() {
    ...
    this.slidePopuplist(payload)
  },

  methods: {
    ...mapActions('cms', ['slidePopuplist']),
      ...
      this.$swal({
        ...
        if (result.value) {
          ...
          useJwt
            .createData(
              'cms',
              `/slide-popup-images-update?id=${id}&type=popup`,
              getFormData(body),
              {
                headers: {
