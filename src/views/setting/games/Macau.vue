<template>
  <b-card-code>
    <b-form @submit.prevent>
      <h3 class="mt-3 ml-3">Colok Macau Setting</h3>
      <b-row class="mx-2 mt-3" v-for="data in dataSettings" :key="data">
        ...
        <!-- Win 2 Digit (x) -->
        <b-col cols="2">
          <b-form-group label="Win 2 Digit (x)">
            <b-form-input
        ...
        <!-- Win 3 Digit (x) -->
        <b-col cols="2">
          <b-form-group label="Win 3 Digit (x)">
            <b-form-input
        ...
        <!-- Win 4 Digit (x) -->
        <b-col cols="2">
          <b-form-group label="Win 4 Digit (x)">
            <b-form-input
      ...
      <b-col class="mb-3 mt-2 ml-2">
        <b-button
          ...
          variant="primary"
          class="mr-1"
          @click="updateMacau('success', 'top-center', dataSettings)"
        >
          Submit Settings
        </b-button>
      </b-col>
...
export default {
  ...
  methods: {
    ...mapActions('settings', ['updateColokMacau']),
    ...
    async updateMacau(variant, position, item) {
      ...
      if (res.value) {
        if (await this.updateColokMacau(item)) {
