  ...
  <div>
    ...
    >
      <template #default="{ hide }">
        ...
        >
          <b-button :variant="taskLocal.isCompleted ? '' : 'outline-danger'">
            <feather-icon
                ...
                <b-media-body>
                  <div class="mail-details">
                    ...
                    <div class="mail-meta-item">
                      <span class="mx-50 bullet bullet-danger bullet-sm" />
  ...
  methods: {
    pollData() {
      this.notify = setInterval(() => {
        this.$store.dispatch('services/fetchWithdraw')
      }, 2000)
    },

    goToWithdraw() {
      this.$router.push('/services/withdraw')
    },
